...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.firstname && firstname.lenth < 3){
            errors.firstname = 'First name should be more than 3 characters';
        }
        else if (this.state.touched.firstname && firstname.lenth > 10){
            errors.firstname = 'First name should be less than 10 characters';
        }
        if(this.state.touched.lastname && lastname.lenth < 3){
            errors.lastname = 'Last name should be more than 3 characters';
        }
        else if (this.state.touched.lastname && lastname.lenth > 10){
